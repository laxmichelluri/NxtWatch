...
class SearchVideos extends Component {
  ...
  renderLoadingView = () => (
    <ProductsLoaderContainer
      ...
      data-testid="loader"
    >
      <Loader type="ThreeDots" colors="#0b69ff" height="50" width="50" />
    </ProductsLoaderContainer>
  )
        ...
        return isVideosAvailable ? (
          <div>
            ...
            <Desc className="no-products-description">
              Try different key or remove search filter
            </Desc>
  ...
  renderFailureView = () => (
    <NotFoundContainer>
      ...
      <Desc className="jobs-failure-description">
        We are having some trouble to complete your requests.Please try again.
      </Desc>
      <NavLink>
        <Retry onClick={this.getSuggestionVideos}>Retry</Retry>
      </NavLink>
